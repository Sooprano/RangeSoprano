  ...
  },
  {
    ...
    a: (
      <>
        ...
        hay tres grupos. <span className="font-medium text-content">Conceptos</span> reúne diez
        drills cortos. <span className="font-medium text-content">¿Qué calculadora?</span>:
