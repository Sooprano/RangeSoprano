  ...
  },
  {
    ...
    a: (
      <>
        ...
        hay dos grupos. <span className="font-medium text-content">Conceptos</span> reúne nueve
        ...
        shove — el insight es considerar el all-in, no solo call/fold. El otro grupo,{' '}
