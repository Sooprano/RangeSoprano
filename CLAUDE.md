...
Fases 1-49 completadas ✅. Detalle completo de cada fase, hashes de rollback y decisiones de diseño no obvias → `RECOVERY.md`.
...
49. Apariencia de la mesa del Entrenador: cartas volteadas del villano + mesa personalizable (9 preajustes · capas felt/borde/marco/fondo · riel interior · forma estadio/oval largo · caja del jugador · reverso de cartas) en un modal, sin ruta nueva
